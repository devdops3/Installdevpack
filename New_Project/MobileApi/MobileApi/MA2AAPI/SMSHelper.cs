...
namespace MA2AAPI
{
    public class SMSHelper
    {
        ...
        public string getMessageTopup(string agentName, string taxID, string biller, string pin, string serialNo, string expiry, string amount, string shopCode)
        {
            ...
            //sb.Append(" *" +biller + " *PIN : " + pin + " *Amount : " + amount  + " *Shop : " + shopCode);

            if (taxID == "2222222222222" || taxID == "0000000000024")//MPT-CDMA 800|| 450
            {
                sb.Append("*166*" + pin + "#");
            }
     ...
     string ref1Value, string ref2Value, string ref3Value, string ref4Value, string amount, string serviceFee, string totalAmount, string shopCode)
             ...
             string ref1Value, string ref2Value, string ref3Value, string ref4Value, string amount, string serviceFee, string totalAmount, string shopCode)
        {
            ...
            {
                if (!String.IsNullOrEmpty(ref1Name))
                    sb.Append(" *" + ref1Name + ": " + HttpUtility.HtmlEncode(ref1Value));
                sb.Append(" *" + "Name" + ": " + HttpUtility.HtmlEncode(ref2Value));
            ...
            else if (taxID == ConfigurationManager.AppSettings["AeonTaxId"].ToString())
            {
                if (!String.IsNullOrEmpty(ref1Name))
                    sb.Append(" *" + ref1Name + " : " + ref1Value);

                if (!String.IsNullOrEmpty(ref2Value))
                    sb.Append(" *" + "Customer Name" + " : " + ref2Value);
        ...
        public string getMessageBillerWithTxnDateTime(string agentName, string taxID, string biller, string ref1Name, string ref2Name, string ref3Name, string ref4Name,
        string ref1Value, string ref2Value, string ref3Value, string ref4Value, string txnDateTime, string amount, string serviceFee, string totalAmount, string shopCode, string txnDateTimeValue)
        {
            StringBuilder sb = new StringBuilder();
            ...
            if (!String.IsNullOrEmpty(txnDateTime))
                sb.Append(" *" + txnDateTime + " : " + txnDateTimeValue);
            ...
            string ref1Value, string ref2Value, string ref3Value, string ref4Value, string amount, string serviceFee, string totalAmount, string shopCode)
        {
            ...
            {
                txnId = ref4Value.Split('|')[1].ToString();
                ref4Value = ref4Value.Split('|')[0].ToString();
            }
    ...
    string ref1Value, string ref2Value, string ref3Value, string ref4Value, string amount, string serviceFee, string totalAmount, string shopCode)
        {
            ...
            if (!String.IsNullOrEmpty(ref4Name) && !String.IsNullOrEmpty(ref4Value) && ref4Name != "Ref")
                sb.Append(" *" + ref4Name + " : " + ref4Value);
